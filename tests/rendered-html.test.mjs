...
try{
 ...
 assert.match(html,/Skip to content/);assert.match(html,/Open section navigation/);assert.match(html,/Download résumé/);assert.match(html,/utkarsh-mankad-resume\.pdf/);assert.match(html,/Senior engineering leader building AI, data, and distributed platforms/);assert.match(html,/Portfolio telemetry/);assert.match(html,/PROFILE_VISITS/);assert.match(html,/RESUME_DOWNLOADS/);assert.match(html,/Return visits are repeat loads/);
