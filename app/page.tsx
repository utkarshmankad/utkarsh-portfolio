...
const roles = [
  ...
  { period: "2010 — 2021", company: "CDAC · Government of India", role: "SDE 2 → SDE 3 → Architect → Engineering Manager", summary: "Progressed from individual contributor to technical architect and then manager of 12 engineers across IoT and AR. Owned a ₹300 Cr+ portfolio spanning five government-scale initiatives; delivered 10+ public products including COVID Mitra across four states, a unified LMS for 50+ institutions, and Smart City dashboards in three cities. Earlier, architected a 45 GB/day water-network pipeline for 8,000 sensors, independently shipped the Namma Metro app to 1.2M+ downloads, grew an Android/AR team from two to seven, and delivered the Smart Post Kiosk and EPFO identity-verification backend.", wins: ["12-engineer organisation", "₹300 Cr+ portfolio", "10+ public products", "1.2M+ app downloads", "8,000 IoT sensors", "4-state COVID deployment"], tech: ["Java", "Android SDK", "Node.js", "Angular", "React", "IoT Data Pipelines"] },
];
...
export default function Home() {
  ...
  return <main id="top">
    ...
    <section className="section shell leadership-section"><SectionTitle number="06" label="Leadership protocol">Clarity over noise. Outcomes over activity.</SectionTitle><div><p>Durable systems and durable teams are built the same way: with clear interfaces, honest feedback, calm ownership, and room to grow.</p><blockquote>Turn ambiguity into direction—and leave every system stronger than you found it.</blockquote></div></section>
