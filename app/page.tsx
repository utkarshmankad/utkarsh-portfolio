...
export default function Home() {
  ...
  return <main id="top">
    ...
    <nav className="nav shell" aria-label="Primary navigation"><a className="brand" href="#top" aria-label="Utkarsh Mankad, back to top"><span>U</span>M_</a><div className={`nav-links${mobileMenuOpen ? " is-open" : ""}`} id="primary-navigation"><a href="#work" onClick={closeMobileMenu}>01.Work</a><a href="#products" onClick={closeMobileMenu}>02.Products</a><a href="#projects" onClick={closeMobileMenu}>03.Builds</a><a href="#open-source" onClick={closeMobileMenu}>04.OSS</a><a href="#writing" onClick={closeMobileMenu}>05.Writing</a><a href="#contact" onClick={closeMobileMenu}>06.Contact</a></div><button className="menu-button" type="button" aria-controls="primary-navigation" aria-expanded={mobileMenuOpen} aria-label={`${mobileMenuOpen ? "Close" : "Open"} section navigation`} onClick={() => setMobileMenuOpen(!mobileMenuOpen)}><span aria-hidden>{mobileMenuOpen ? "×" : "≡"}</span>Menu</button><button className="theme-button" onClick={() => setDark(!dark)} aria-label={`Switch to ${dark ? "light" : "dark"} theme`}><span aria-hidden>{dark ? "☼" : "◐"}</span>{dark ? "Light" : "Dark"}</button></nav>

    <header className="hero shell" id="content" tabIndex={-1}><div className="hero-intro"><div><div className="hero-signal"><span>SYS.STATUS</span><b>OPEN_TO_LEADERSHIP_ROLES</b><i /></div><p className="eyebrow">Senior engineering leader / AI &amp; data platforms / Distributed systems</p></div><div className="profile-photo"><Image src="/utkarsh.jpg" alt="Utkarsh Mankad" width={88} height={88} priority /></div></div><h1>Building teams.<br />Engineering <em>impact.</em></h1><div className="hero-bottom"><p>Senior engineering leader building AI, data, and distributed platforms—and the teams that operate them at scale.</p><div className="hero-actions" aria-label="Portfolio actions"><a className="primary-action" href="#work"><span aria-hidden>$</span> View selected work</a><a href="/utkarsh-mankad-resume.pdf" download>Download résumé ↓</a><a href="#contact">Contact me ↘</a></div></div><div className="metrics"><article><small>EXP_YRS</small><b>16</b></article><article><small>ENGINEERS_LED</small><b>20</b></article><article><small>TEAMS_BUILT</small><b>04</b></article><article><small>MERCHANTS_SERVED</small><b>5M+</b></article></div></header>
    ...
    <footer id="contact"><div className="shell"><p className="footer-code">READY_FOR_NEXT_CHALLENGE = TRUE</p><h2>Let’s engineer<br /><em>what’s next.</em></h2><div className="contact-actions"><a className="contact-link" href="mailto:utkarsh.mankad@gmail.com">Email Utkarsh <span>↗</span></a><a className="resume-link" href="/utkarsh-mankad-resume.pdf" download>Download résumé ↓</a></div><div className="footer-bottom"><span>© {new Date().getFullYear()} Utkarsh Mankad</span><div><a href="https://github.com/utkarshmankad" target="_blank" rel="noreferrer">GitHub ↗</a><a href="https://www.linkedin.com/in/utkarsh-mankad/" target="_blank" rel="noreferrer">LinkedIn ↗</a></div><a href="#top">Back to top ↑</a></div></div></footer>
  </main>;
}
